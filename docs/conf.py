...
"""
platform-plugin-ecommerce-api documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-ecommerce-api',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/platform-plugin-ecommerce-api",
...
#
# html_title = 'platform-plugin-ecommerce-api v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_ecommerce_api'),
                os.path.join(root_path, 'platform_plugin_ecommerce_api/migrations')])
